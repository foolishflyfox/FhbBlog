...
import com.bfh.dao2.CustomerDao;
import com.bfh.dao2.CustomerDaoImpl;
...
public class CustomerDaoImplTest2 {
    ...
    @Test
    public void getMaxBirth2() {
        try {
            Connection conn = JDBCPoolUtils.getConnectionWithDBCP();
            Date maxBirth = dao.getMaxBirth(conn);
            System.out.println("最大生日为: " + maxBirth);
        } catch (Exception e) {
            System.out.println("查询最大生日失败");
